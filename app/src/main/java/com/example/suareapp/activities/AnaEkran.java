...
public class AnaEkran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton button_logout=(ImageButton)findViewById(R.id.logout);

        button_konum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent topage1=new Intent(AnaEkran.this, Location_Person.class);
        ...
        button_konum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent topage2=new Intent(AnaEkran.this, MapsActivity.class);
                startActivity(topage2);
            }
        });
        ...
        button_kolayoku.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent topage2=new Intent(AnaEkran.this, KolayOku.class);
                startActivity(topage2);
            }
        });
